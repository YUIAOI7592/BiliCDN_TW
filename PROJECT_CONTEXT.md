...
目前交付為 v1.9.2，以不可變已發布 v1.9.0（SHA-256 f7628173de6fce49bd8606ac31ab647a7bd02152bc6ab6b93c437524ead74f9f）為封裝基準。v1.9.1 的隔夜起播保護與 v1.9.2 的長暫停影片核心重建一併交付：自動量測等待穩定播放；恢復後若音訊存活但影片 core 持續未初始化，才以一次 `player.reload()` 重建並恢復位置、倍速與播放意圖。
...
- 原始碼 src；目前交付 Release/v1.9.2；暫存 dist。功能驗收狀態見本版 TEST_REPORT，不以舊版通過狀態代替。
