...
(() => {
  ...
  function createVideoCoreRecovery(deps) {
    ...
    const tick = /* @__PURE__ */ __name((currentVideo, playback) => {
      ...
      const supportingEvidence = trustedStrong ? true : strong ? audioAdvanced || playback.bufferAheadSec > 0 || stagnant : audioAdvanced;
    ...
    const buildPublicDiagnosticSnapshot = /* @__PURE__ */ __name(() => {
      ...
      return deepFreezePublic({
        ...
        videoCore: {
          ...
          intentSource: ["none", "trusted-media-play", "paused-transition"].includes(videoCore.intentSource) ? videoCore.intentSource : "none",
