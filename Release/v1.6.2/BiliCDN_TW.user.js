  ...
  function createWorker(deps) {
    ...
    const setupClassicWorkerIntercept = /* @__PURE__ */ __name(() => {
      ...
      try {
        ...
        const classicWorkerPatch = /* @__PURE__ */ __name((originalUrl, capability) => `
(() => {
...
`, "classicWorkerPatch");
        const moduleWorkerPatch = /* @__PURE__ */ __name((originalUrl, capability) => `
(() => {
${sharedWorkerPatch(originalUrl, capability)}
})();
...
`, "moduleWorkerPatch");
        ...
        const registerWorker = /* @__PURE__ */ __name((worker, capability, blobUrl) => {
          ...
          try {
            ...
            try {
              if (channel && channel.port1) channel.port1.close();
            } catch {
            }
            try {
              if (channel && channel.port2) channel.port2.close();
            } catch {
            }
