...
(() => {
  ...
  function createSettings(deps, input) {
    ...
    const VERSION = typeof GM_info !== "undefined" && GM_info.script && GM_info.script.version || "1.8.3";
  ...
  function createNativeRoutes(deps) {
    ...
    const setPlannedAffinity = /* @__PURE__ */ __name((next, reason) => {
